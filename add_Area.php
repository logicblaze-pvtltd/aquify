                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" name="name" class="form-control" id="floatingnameInput" placeholder="Enter Name" style="border: none;border-bottom: 2px solid #556ee6;border-radius:0;" required>
                                                        <label for="floatingnameInput">Area</label>
                                                    </div>
                                                </div>
                                                </div>
